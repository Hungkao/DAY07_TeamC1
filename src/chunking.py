...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Split at whitespace following a sentence-ending punctuation mark. The
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # Once natural boundaries are exhausted, fall back to fixed-size
        # slicing. This also handles an explicitly empty separator list.
        ...
        for part in parts:
            ...
            if not current_chunk or len(current_chunk) + len(part) <= self.chunk_size:
                current_chunk += part
            else:
                chunks.append(current_chunk)
                current_chunk = part
